 <!-- main header -->
<header class="main-header header-two menu-absolute">
    <!--Header-Upper-->
            ...
            <div class="header-inner rel d-flex align-items-center">
                ...
                <div class="menu-btns">
                    ...
                    <div class="menu-sidebar">
                        <button>
                            <img src="{{ asset('/assets/images/shape/sidebar-tottler-white.svg') }}" alt="Toggler">
                        </button>
                    </div>
                    
                    <a href="{{ route('contact') }}" class="theme-btn">let,s talk</a>
                </div>
            </div>
        </div>
    </div>
...
@include('frontend.includes.partials.offcanvas')