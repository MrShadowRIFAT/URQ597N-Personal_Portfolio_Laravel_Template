                    ...
                    <div class="row gap-100">
                        <div class="col-lg-5">
                            <div class="skill-content-part rel z-2 rmb-55 wow fadeInUp delay-0-2s">
                                ...
                                <a href="{{ route('about') }}" class="theme-btn">Learn More <i class="far fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-7">
                        ...
                        <div class="col-lg-6">
                            <div class="blog-item wow fadeInUp delay-0-2s">
                                ...
                                <div class="content">
                                    ...
                                    <h5><a href="{{ route('blogDetails') }}">Keyboard-Only Suppor Assistive Technology</a></h5>
                                    <hr>
                                    <div class="blog-meta mt-35">
                                        <a class="date" href="#"><i class="far fa-calendar-alt"></i> September 25, 2023</a>
                                    </div>
