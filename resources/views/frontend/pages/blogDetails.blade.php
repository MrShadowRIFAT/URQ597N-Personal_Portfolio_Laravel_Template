                        ...
                        <div class="blog-details-wrap">
                            ...
                            <div class="content">
                                <div class="next-prev-post pt-50 pb-20 wow fadeInUp delay-0-2s">
                                    <div class="post-item">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/blog/post-prev.jpg') }}" alt="Post">
                                        </div>
                                        <div class="post-content">
                                            ...
                                            <h6><a href="{{ route('blogDetails') }}">Tips For Conducting Studie</a></h6>
                                        </div>
                                    </div>
                                    <div class="post-item">
                                        <div class="image">
                                            <img src="{{ asset('/assets/images/blog/post-next.jpg') }}" alt="Post">
                                        </div>
                                        <div class="post-content">
                                            <span class="date">
                                                <i class="far fa-calendar-alt"></i>
                                            ...
                                            <h6><a href="{{ route('blogDetails') }}">Usability With Participants</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
