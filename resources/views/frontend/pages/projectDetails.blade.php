        ...
        <section class="projects-details-area pt-40 pb-130 rpb-100 rel z-1">
            <div class="container">
                <div class="projects-details-image mb-50 wow fadeInUp delay-0-2s">
                    <img src="{{ asset('/assets/images/projects/project-details.jpg') }}" alt="Project Details">
                </div>
                ...
                <div class="row pb-15">
                    <div class="col-lg-4 col-sm-6">
                        <div class="image mb-30 wow fadeInUp delay-0-2s">
                            <img src="{{ asset('/assets/images/projects/project-middle1.jpg') }}" alt="Project Middle">
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="image mb-30 wow fadeInUp delay-0-4s">
                            <img src="{{ asset('/assets/images/projects/project-middle2.jpg') }}" alt="Project Middle">
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="image mb-30 wow fadeInUp delay-0-6s">
                            <img src="{{ asset('/assets/images/projects/project-middle3.jpg') }}" alt="Project Middle">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="project-item style-two wow fadeInUp delay-0-2s">
                            <div class="project-image before-after-none">
                                <img src="{{ asset('/assets/images/projects/related-project1.jpg') }}" alt="Project">
                            </div>
                            <div class="project-content">
                                <span class="sub-title">Graphics Design</span>
                                <h4><a href="{{ route('projectDetails') }}">Brand Identity Design</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="project-item style-two wow fadeInUp delay-0-4s">
                            <div class="project-image before-after-none">
                                <img src="{{ asset('/assets/images/projects/related-project2.jpg') }}" alt="Project">
                            </div>
                            <div class="project-content">
                                <span class="sub-title">Product Design</span>
                                <h4><a href="{{ route('projectDetails') }}">Mobile Apps Design</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="project-item style-two wow fadeInUp delay-0-6s">
                            <div class="project-image before-after-none">
                                <img src="{{ asset('/assets/images/projects/related-project3.jpg') }}" alt="Project">
                            </div>
                            <div class="project-content">
                                <span class="sub-title">Product Design</span>
                                <h4><a href="{{ route('projectDetails') }}">Dashboard Development</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
