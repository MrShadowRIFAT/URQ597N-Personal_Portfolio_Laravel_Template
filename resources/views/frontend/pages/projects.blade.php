...
@section('title', 'Project Grid View')
@section('content')
    <!-- header area -->
                ...
                <div class="row project-masonry-active">
                    <div class="col-lg-6 item branding development">
                        <div class="project-item style-two wow fadeInUp delay-0-2s">
                            ...
                            <div class="project-content">
                                ...
                                <h3><a href="{{ route('projectDetails') }}">Mobile Application Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 item design marketing graphics">
                        <div class="project-item style-two wow fadeInUp delay-0-4s">
                            ...
                            <div class="project-content">
                                <span class="sub-title">Product Design</span>
                                <h3><a href="{{ route('projectDetails') }}">Website Makeup Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 item development graphics">
                        <div class="project-item style-two wow fadeInUp delay-0-2s">
                            ...
                            <div class="project-content">
                                ...
                                <h3><a href="{{ route('projectDetails') }}">Brand Identity and Motion Design</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 item branding marketing graphics">
                        <div class="project-item style-two wow fadeInUp delay-0-2s">
                            <div class="project-image">
                                <img src="{{ asset('/assets/images/projects/project5.jpg') }}" alt="Project">
                                <a href="{{ route('projectDetails') }}" class="details-btn"><i class="far fa-arrow-right"></i></a>
                            </div>
                            <div class="project-content">
                                <span class="sub-title">Design & Branding</span>
                                <h3><a href="{{ route('projectDetails') }}">Creative Graphics Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 item design marketing apps">
                        <div class="project-item style-two wow fadeInUp delay-0-4s">
                            <div class="project-image">
                                <img src="{{ asset('/assets/images/projects/project6.jpg') }}" alt="Project">
                                <a href="{{ route('projectDetails') }}" class="details-btn"><i class="far fa-arrow-right"></i></a>
                            </div>
                            <div class="project-content">
                                <span class="sub-title">Product Design</span>
                                <h3><a href="{{ route('projectDetails') }}">Design & Branding Mokeup</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
