        ...
        <div class="about-main-image-area pt-40">
            <div class="container">
                <div class="about-main-image wow fadeInUp delay-0-5s">
                    <img src="{{ asset('/assets/images/about/about-page.jpg') }}" alt="About Page">
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6">
                        <div class="about-page-content-part rel z-2 rmb-55">
                            ...
                            <a href="{{ route('about') }}" class="theme-btn wow fadeInUp delay-0-2s">Learn More <i class="far fa-angle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="about-right-part wow fadeInLeft delay-0-3s">
                            ...
                            <div class="dot-shape one">
                                <img src="{{ asset('/assets/images/shape/about-dots-two.png') }}" alt="Shape">
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="faq-image-part rmb-55 wow fadeInUp delay-0-2s">
                            <div class="image-one">
                                <img src="{{ asset('/assets/images/faqs/faq-one.jpg') }}" alt="FAQ">
                            </div>
                            <div class="image-two">
                                <img src="{{ asset('/assets/images/faqs/faq-two.jpg') }}" alt="FAQ">
                            </div>
